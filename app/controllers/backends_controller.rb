class BackendsController < ApplicationController
  ...
  def backend_module_post
    ...
    @post = current_user.posts.build(backend_params) if backend_params
  ...
  def backend_params
    params.require(:post).permit(:content, :frontend, :javascript, :backend, :frontend_css, :database_id,
                                 :instruction, :slug, :module_type, :tags_id)
  end
end
