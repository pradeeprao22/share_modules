    ...
    if !Follow.first.nil?
      Follow.all.map do |follow|
        if follow.follower_id == current_user.id
          ...
          @notification.update(name: action, user_id: current_user.id, reciver_id: @notify_user,
